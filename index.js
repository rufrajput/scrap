...
function executeExAsync(callback) {
   ...
   // R("ex-async.R")
   //      .data("hello world", 20)
   //      .callSync(function(error,result){
   //       if (error) {
   //          console.error('ex-async throws error1', error);
   //          return callback(error, null);
   //       }
   //       console.error('ex-async success result', result);
   //       return callback(null, result);                   });

   var out = R("ex-async.R")
...
app.get('/', function(req, res) {
	res.send('Hello World Go to - <a href="http://localhost:8082/ex-async"> http://localhost:8081/ex-async</a>');
});
